...
public class KeysScreen extends Screen {
    ...
    private void rebuild() {
        ...
        for (int i = 0; i < ACTIONS.size(); i++) {
            ...
            Button b = new Button(this.width / 2 - 130, y, 260, 20, Component.literal(display), btn -> {
        ...
        addRenderableWidget(new Button(this.width / 2 - 130, y + 8, 260, 20,
                Component.translatable("holyswap.screen.keys.reset"), btn -> {
        ...
        addRenderableWidget(new Button(this.width / 2 - 60, this.height - 30, 120, 20,
                Component.translatable("holyswap.screen.back"), btn -> onClose()));
    }
    ...
    public void render(PoseStack poseStack, int mouseX, int mouseY, float delta) {
        ...
        drawCenteredString(poseStack, font, Component.translatable("holyswap.screen.keys.hint"), this.width / 2, 28, 0xAAAAAA);
    }
